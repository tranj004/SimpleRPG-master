...
namespace Engine.Factories
{
    internal static class WorldFactory
    {
        ...
        private static void LoadLocationsFromNodes(World world, string rootImagePath, XmlNodeList nodes)
        {
            ...
            {
                Locations location =
                    new Locations(node.AttributeAsInt("X"),
        ...
        private static void AddMonsters(Locations location, XmlNodeList monsters)
        {
            if (monsters == null)
            {
                return;
        ...
        private static void AddQuests(Locations location, XmlNodeList quests)
        {
            if (quests == null)
            {
                return;
        ...
        private static void AddTrader(Locations location, XmlNode traderHere)
        {
            if (traderHere == null)
            {
                return;
